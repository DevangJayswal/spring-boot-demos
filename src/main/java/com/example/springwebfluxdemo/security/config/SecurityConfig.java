...
//            return Mono.just(sfdcAuthenticationManager());
        };
    }
    ...
    public ReactiveAuthenticationManager sfdcAuthenticationManager() {
        return authentication -> sfdcAuthenticationProvider(authentication)
                .map(b -> new SfdcAuthenticationToken(
                                authentication.getPrincipal(), authentication.getCredentials(), null
                        )
                );
    }

    public Mono<String> sfdcAuthenticationProvider(Authentication authentication) {
